#!/usr/bin/env python3
"""Check sim/spr_gfx_tb's fetched SPRITE rows against tools/f3_gfx.py.
...
pf = f3_gfx.load_sprite_gfx(os.path.join(dump, "rgn_sprites.bin"),
                            os.path.join(dump, "rgn_sprites_hi.bin"))
bad = n = 0
...
print(f"{n - bad}/{n} sprite rows match the validated decoder")
